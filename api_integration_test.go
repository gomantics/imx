	...
	result := imxtest.AssertDirectories(meta.Directories(), []imxtest.DirectoryExpectation{
		{
			...
			Tags: []imxtest.TagExpectation{
				...
				{Name: "ColorSpace", Value: uint16(65535)},
				{Name: "ComponentsConfiguration", Value: []byte{1, 2, 3, 0}},
				{Name: "CustomRendered", Value: uint16(7)},
				...
				{Name: "ExposureMode", Value: uint16(0)},
				{Name: "ExposureProgram", Value: uint16(2)},
				{Name: "ExposureTime", Value: "1/758"},
				{Name: "FNumber", Value: "9/5"},
				{Name: "Flash", Value: uint16(24)},
				...
				{Name: "MeteringMode", Value: uint16(5)},
		...
		},
		{
			...
			Tags: []imxtest.TagExpectation{
				...
				{Name: "Orientation", Value: uint16(1)},
				{Name: "ResolutionUnit", Value: uint16(2)},
				{Name: "Software", Value: "13.0"},
				{Name: "XResolution", Value: "72/1"},
				{Name: "YCbCrPositioning", Value: uint16(1)},
		...
		},
		{
			...
			ExactTagCount: 6,
			Tags: []imxtest.TagExpectation{
				{Name: "Compression", Value: uint16(6)},
	...
	result := imxtest.AssertDirectories(meta.Directories(), []imxtest.DirectoryExpectation{
		{
			...
			Tags: []imxtest.TagExpectation{
				...
				{Name: "Compression", Value: uint16(6)},
				{Name: "Orientation", Value: uint16(8)},
				{Name: "XResolution", Value: "72/1"},
				{Name: "YResolution", Value: "72/1"},
				{Name: "ResolutionUnit", Value: uint16(2)},
		...
		},
		{
			...
			Tags: []imxtest.TagExpectation{
				...
				{Name: "ColorSpace", Value: uint16(1)},
				...
				{Name: "FocalPlaneResolutionUnit", Value: uint16(2)},
				{Name: "CustomRendered", Value: uint16(0)},
				{Name: "ExposureMode", Value: uint16(0)},
				{Name: "WhiteBalance", Value: uint16(0)},
				{Name: "SceneCaptureType", Value: uint16(0)},
			},
